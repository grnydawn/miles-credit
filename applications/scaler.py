...
def main():
    ...
    parser.add_argument("-g", "--fitdt", action="store_true", help="Fit scaler to time residuals of scaled data.")
    ...
    if args.fit:
        scalers = fit_era5_scaler_times(era5_subset_times, rank, era5_file_dir=e5_file_dir,
                                        vars_3d=vars_3d, vars_surf=vars_surf, scaler_type=scaler_type,
...
def transform_era5_times(times, rank, scaler_file=None, era5_file_dir=None, vars_3d=None, vars_surf=None,
    ...
    for t, ctime in enumerate(times_index):
        ...
        out_ds.to_netcdf(full_out_filename, encoding={"levels": var_encoding,
                                                      "surface": var_encoding})
    eds.close()
    return


def fit_scaled_era5_time_residuals(times, rank, era5_file_dir=None, dt=1, scaler_type="standard",
                          scaler_config=None):
    """
