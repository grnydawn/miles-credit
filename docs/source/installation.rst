...
This section provides instructions on how to download, configure, and run the ML research platform under AF.

Downloading the ML research platform
--------------------------------------

The ML research platform is a Python project managed with Git. To obtain the source code, clone the `repository <https://github.com/grnydawn/miles-credit.git>`_ and switch to `frontier` branch using the following commands:
